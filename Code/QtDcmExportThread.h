...
public:
    ...
    void setServerPacsParam ( QString param );

    void setLocalPacsParam ( QString param );

    void setTemporaryDir ( QString dir );

    void setSeriesToExport ( QList<QString> list );

    void setModality ( QString modality );

    void setAetitle ( QString ae );
};
