...
void QtDcmPreviewDialog::initConnections()
{
...
void QtDcmPreviewDialog::showMode1()
{
    _scene->clear();
...
void QtDcmPreviewDialog::showMode2()
{
    _scene->clear();
...
void QtDcmPreviewDialog::showMode4()
{
    _scene->clear();
...
void QtDcmPreviewDialog::showMode8()
{
    _scene->clear();
...
void QtDcmPreviewDialog::updatePreview()
{
    switch ( _mode )
    {
...
void QtDcmPreviewDialog::tool1ButtonClicked()
{
    _mode = 1;
    this->updatePreview();
}

void QtDcmPreviewDialog::tool2ButtonClicked()
{
    _mode = 2;
    this->updatePreview();
}

void QtDcmPreviewDialog::tool4ButtonClicked()
{
    _mode = 4;
    this->updatePreview();
}

void QtDcmPreviewDialog::tool8ButtonClicked()
{
    _mode = 8;
    this->updatePreview();
}
